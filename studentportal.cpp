...
cout<<"not regestired";
// registration dates of semesters//

int time =1;
if(time ==1)
cout<<"register to the first semester"<<endl;
else if  (time== 2)
cout<<"register to the second semester"<<endl;
else if (time == 3)
cout<<"register to the third semester"<<endl;
else 
cout<<"dont register"<<endl;
